...
@section('title', 'Admin Catalogue Add')

@section('content')
<form action="{{route('admin.catalogue.update', $catalogue->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$catalogue->title}}" name="title"
                ...
                <div class="form-group">
                    ...
                    <select name="category" class="border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-primary mb-5">
                        <option value="{{$catalogue->category->id}}">{{ucfirst($catalogue->category->title)}}</option>
