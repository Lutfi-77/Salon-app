        ...
        <div class="grid grid-cols-1 gap-5">
            ...
            <div class="card w-full overflow-hidden shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)] rounded-lg bg-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 w-full">
                    <a href="{{route('admin.appointment.changeStatus', ['id' => $detailAppointment->id, 'status' => 'selesai'])}}" class="bg-blue-700 w-full text-white text-center px-2 py-2">Selesai</a>
                    <a href="{{route('admin.appointment.changeStatus', ['id' => $detailAppointment->id, 'status' => 'batal'])}}" class="block bg-red-700 w-full text-white text-center px-2 py-2" data-confirm-delete="true">Cancel Treatment</a>
                </div>
            </div>
            @endforeach
        </div>
