        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === '{{$link['title']}}') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="#"
              @click.prevent="selected = (selected === 'Account' ? '':'Account')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Account') || (page === 'formElements' || page === 'formLayout') }"
            >
              <svg
                class="fill-current"
                width="18"
              ...
              <svg
                ...
                :class="{ 'rotate-180': (selected === 'Account') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              ...
              :class="(selected === 'Account') ? 'block' :'hidden'"
            >
