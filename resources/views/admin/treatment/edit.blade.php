...
@section('title', 'Admin Treatment Update')

@section('content')
<form action="{{route('admin.treatment.update', $treatment->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{$treatment->name}}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5">{{$treatment->desc}}</textarea>
                </div>
                <div class="form-group">
                    <label class="mb-2 block">Price</label>
                    <input type="text" name="price" value="{{$treatment->price}}" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5" placeholder="ex: 120-150k" required />
                </div>
                <div class="form-group">
