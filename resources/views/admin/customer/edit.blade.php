        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{$customer->name}}" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5"
                        required />
                </div>
                <div class="form-group">
                    <label class="mb-2 block">Email</label>
                    <input type="email" name="email" value="{{$customer->email}}" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5"
                        required readonly />
                </div>
                <div class="form-group">
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="form-group">
                    ...
                    <input type="text" name="phone" value="{{$customer->customer ? $customer->customer->phone : ''}}" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5"
                        required />
                </div>
                <div class="form-group">
                    <label class="mb-2 block">Address</label>
                    <textarea name="address" class="appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary mb-5">{{$customer->customer ? $customer->customer->address : ''}}</textarea>
                </div>
                <div class="form-group">
